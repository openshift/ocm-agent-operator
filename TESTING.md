...
Testing guidelines for the OCM Agent Operator.
...
**Minimal validation:**
```bash
# After changing pkg/ocmagenthandler/
go test ./pkg/ocmagenthandler/
```
...
It("should create deployment", func() {
    // Create OcmAgent resource
    ocmAgent := &v1alpha1.OcmAgent{...}
    Expect(k8sClient.Create(ctx, ocmAgent)).To(Succeed())
