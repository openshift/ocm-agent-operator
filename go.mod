...
replace (
	github.com/openshift/api => github.com/openshift/api 0616345087ce
	k8s.io/api => k8s.io/api v0.37.0
	k8s.io/apimachinery => k8s.io/apimachinery v0.37.0
	k8s.io/client-go => k8s.io/client-go v0.37.0
	sigs.k8s.io/cluster-api-provider-aws => github.com/openshift/cluster-api-provider-aws 197760fdc9fd
