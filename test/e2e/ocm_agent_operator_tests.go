...
var _ = ginkgo.Describe("ocm-agent-operator", ginkgo.Ordered, func() {
	...
	// Helper function to cleanup existing OcmAgent CR if it exists
	...
	// Helper function to create OcmAgent CR with given spec
	...
	// Helper function to cleanup OcmAgent CR after test
	...
	// Helper function to get OCM Base URL from environment or operator ConfigMap
