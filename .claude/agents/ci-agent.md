...
CI/CD validation and workflow integrity for OCM Agent Operator.
...
# tkn pipeline validate -f .tekton/ocm-agent-operator-pull-request.yaml
...
OCM Agent Operator uses Red Hat boilerplate:
