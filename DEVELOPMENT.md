...
Quick reference for developing the OCM Agent Operator.
...
```bash
# Clone repository
git clone https://github.com/openshift/ocm-agent-operator.git
...
go test ./pkg/ocmagenthandler/...  # Test specific package
...
```bash
# Run specific test
ginkgo -focus="NetworkPolicy" ./pkg/ocmagenthandler/

# Run tests for one package
go test -v ./controllers/ocmagent/
...
- **Controllers**: `controllers/{ocmagent,fleetnotification}/` - Reconciliation logic
- **Business Logic**: `pkg/ocmagenthandler/` - Resource management
